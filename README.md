...
There are many software libraries in the Julia ecosystem that are either built directly upon MTK, or closely interoperate with MTK, to take advantage of the approaches described above. Selected examples, in alphabetical order, include the following: 
