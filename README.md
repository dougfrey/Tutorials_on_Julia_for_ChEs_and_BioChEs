...
It is worth noting that in the typical undergraduate and graduate ChE and BioChE university curricula, computational problems are formulated so that they are "toy" in nature and essentially any computational platform will suffice in their solution. In contrast, this tutorial is aimed at realistic, real-world, large-scale applications where computational efficiency is a significant factor. This tutorial is especially aimed at the common situation where someone wishes to achieve the computational speed of a high-end workstation but using a typical laptop or desktop personal computer.      
